...
export function getAchievementColor(pct: number): string {
 ...
 if (pct >= 90) return 'text-amber-900 ';
 return 'text-red-700 ';
}
...
export function getStatusColor(status: string): string {
 ...
 open: 'text-amber-900 bg-amber-100 ',
 pending: 'text-amber-900 bg-amber-100 ',
 idle: 'text-amber-900 bg-amber-100 ',
...
export function getPriorityColor(priority: string): string {
 ...
 medium: 'text-amber-900 bg-amber-100 border border-amber-300 ',
