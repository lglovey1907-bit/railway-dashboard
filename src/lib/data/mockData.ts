...
export const mockUsers: User[] = [
 ...
 {
 id: 'm1', name: 'Lovey Gandhi', email: 'lovey.gandhi@delhi.nr.in',
 ...
 // ── ADMINISTRATION ─────────────────────────────────────────────────────────
 {
 id: 'a1', name: 'R.K. Sharma', email: 'srdcm.ps@delhi.nr.in',
 ...
 {
 id: 'a2', name: 'P.K. Mishra', email: 'dcm.ps@delhi.nr.in',
 role: 'admin', cell: 'All', designation: 'DCM/PS', division: 'Delhi',
 approved: true, createdAt: '2024-01-12', lastLogin: '2026-06-12T18:00:00Z',
 },
 {
 id: 'a3', name: 'V.S. Negi', email: 'dcm.tc@delhi.nr.in',
 role: 'admin', cell: 'Ticket Checking', designation: 'DCM/TC', division: 'Delhi',
 approved: true, createdAt: '2024-01-15', lastLogin: '2026-06-13T07:30:00Z',
 },
 {
 id: 'a4', name: 'S.K. Gupta', email: 'acm.chg@delhi.nr.in',
 role: 'admin', cell: 'All', designation: 'ACM/Chg.', division: 'Delhi',
 approved: true, createdAt: '2024-01-20', lastLogin: '2026-06-12T20:00:00Z',
 },

 // ── USERS — Cell Members (CMI / COS / OS / Dealers) ───────────────────────
 // 1. Planning
 { id: 'u01', name: 'A.K. Verma', email: 'ak.planning@delhi.nr.in',
 role: 'user', cell: 'Planning', designation: 'CMI/Planning', division: 'Delhi',
 approved: true, createdAt: '2024-02-01',
 fatherHusbandName: 'S. Verma', workingAs: 'CMI',
 listOfWorkAssigned: 'Station category review, NSG/HG data compilation, infrastructure planning coordination', datePostingInCell: '2024-02-01' },
 { id: 'u02', name: 'R. Chandra', email: 'r2.planning@delhi.nr.in',
 role: 'user', cell: 'Planning', designation: 'COS/Planning', division: 'Delhi',
 approved: true, createdAt: '2024-06-15',
 fatherHusbandName: 'M. Chandra', workingAs: 'COS',
 listOfWorkAssigned: 'Planning cell correspondence, data entry support, MIS report compilation', datePostingInCell: '2024-06-15' },
 { id: 'u03', name: 'S. Bisht', email: 's3.planning@delhi.nr.in',
 role: 'user', cell: 'Planning', designation: 'OS/Planning', division: 'Delhi',
 approved: true, createdAt: '2025-01-10',
 fatherHusbandName: 'K. Bisht', workingAs: 'OS',
 listOfWorkAssigned: 'Office administration, file maintenance, dak handling for Planning cell', datePostingInCell: '2025-01-10' },
 // 2. Manpower Planning
 { id: 'u04', name: 'K.K. Sharma', email: 'kk.manpower@delhi.nr.in',
 role: 'user', cell: 'Manpower Planning', designation: 'COS/Manpower', division: 'Delhi',
 approved: true, createdAt: '2024-02-05',
 fatherHusbandName: 'R.N. Sharma', workingAs: 'COS',
 listOfWorkAssigned: 'Staff strength monitoring, vacancy tracking, manpower budget coordination', datePostingInCell: '2024-02-05' },
 { id: 'u05', name: 'N. Joshi', email: 'n2.manpower@delhi.nr.in',
 role: 'user', cell: 'Manpower Planning', designation: 'OS/Manpower', division: 'Delhi',
 approved: true, createdAt: '2024-09-12',
 fatherHusbandName: 'B. Joshi', workingAs: 'OS',
 listOfWorkAssigned: 'Roster preparation, leave records, manpower MIS updates', datePostingInCell: '2024-09-12' },
 // 3. Security D&AR
 { id: 'u06', name: 'Rajeev Gupta', email: 'rajeev.security@delhi.nr.in',
 role: 'user', cell: 'Security D&AR', designation: 'CMI/Security', division: 'Delhi',
 approved: true, createdAt: '2024-02-10',
 fatherHusbandName: 'H.C. Gupta', workingAs: 'CMI',
 listOfWorkAssigned: 'D&AR case monitoring, staff punishment records, vigilance liaison', datePostingInCell: '2024-02-10' },
 { id: 'u07', name: 'A. Thakur', email: 'a2.security@delhi.nr.in',
 role: 'user', cell: 'Security D&AR', designation: 'OS/Security', division: 'Delhi',
 approved: true, createdAt: '2024-11-01',
 fatherHusbandName: 'D. Thakur', workingAs: 'OS',
 listOfWorkAssigned: 'Case file maintenance, inquiry correspondence, record keeping', datePostingInCell: '2024-11-01' },
 // 4. Legal
 { id: 'u08', name: 'Vikram Nair', email: 'vikram.legal@delhi.nr.in',
 role: 'user', cell: 'Legal', designation: 'OS/Legal', division: 'Delhi',
 approved: true, createdAt: '2024-02-15',
 fatherHusbandName: 'P. Nair', workingAs: 'OS',
 listOfWorkAssigned: 'Court case tracking, legal correspondence, advocate liaison', datePostingInCell: '2024-02-15' },
 { id: 'u09', name: 'M. Iyer', email: 'm2.legal@delhi.nr.in',
 role: 'user', cell: 'Legal', designation: 'COS/Legal', division: 'Delhi',
 approved: true, createdAt: '2025-02-20',
 fatherHusbandName: 'K. Iyer', workingAs: 'COS',
 listOfWorkAssigned: 'Legal documentation, RTI replies, case status MIS', datePostingInCell: '2025-02-20' },
 // 5. Marketing
 { id: 'u10', name: 'Anita Mehta', email: 'anita.marketing@delhi.nr.in',
 role: 'user', cell: 'Marketing', designation: 'CMI/Marketing', division: 'Delhi',
 approved: true, createdAt: '2024-02-20',
 fatherHusbandName: 'R.K. Mehta', workingAs: 'CMI',
 listOfWorkAssigned: 'Freight/parcel marketing, customer liaison, revenue generation initiatives', datePostingInCell: '2024-02-20' },
 { id: 'u11', name: 'S. Kohli', email: 's2.marketing@delhi.nr.in',
 role: 'user', cell: 'Marketing', designation: 'Dealer/Marketing', division: 'Delhi',
 approved: true, createdAt: '2024-08-05',
 fatherHusbandName: 'V. Kohli', workingAs: 'Dealer',
 listOfWorkAssigned: 'Advertisement space management, branding coordination', datePostingInCell: '2024-08-05' },
 // 6. Ticket Checking
 { id: 'u12', name: 'Priya Sharma', email: 'priya.tc@delhi.nr.in',
 role: 'user', cell: 'Ticket Checking', designation: 'COS/TC', division: 'Delhi',
 approved: true, createdAt: '2024-03-01',
 fatherHusbandName: 'A.K. Sharma', workingAs: 'COS',
 listOfWorkAssigned: 'TTE roster management, penalty case compilation, ticket checking drives', datePostingInCell: '2024-03-01' },
 { id: 'u13', name: 'R. Pal', email: 'r2.tc@delhi.nr.in',
 role: 'user', cell: 'Ticket Checking', designation: 'CMI/TC', division: 'Delhi',
 approved: true, createdAt: '2024-07-18',
 fatherHusbandName: 'S. Pal', workingAs: 'CMI',
 listOfWorkAssigned: 'TC squad supervision, surprise checks, performance review', datePostingInCell: '2024-07-18' },
 { id: 'u14', name: 'D. Bose', email: 'd3.tc@delhi.nr.in',
 role: 'user', cell: 'Ticket Checking', designation: 'OS/TC', division: 'Delhi',
 approved: true, createdAt: '2025-01-25',
 fatherHusbandName: 'T. Bose', workingAs: 'OS',
 listOfWorkAssigned: 'TC office administration, penalty register maintenance', datePostingInCell: '2025-01-25' },
 // 7. UTS PRS
 { id: 'u15', name: 'Rajesh Kumar', email: 'rajesh.utsprs@delhi.nr.in',
 role: 'user', cell: 'UTS PRS', designation: 'CMI/UTS-PRS', division: 'Delhi',
 approved: true, createdAt: '2024-03-05',
 fatherHusbandName: 'M.L. Kumar', workingAs: 'CMI',
 listOfWorkAssigned: 'UTS/PRS counter monitoring, digital payment targets, revenue reconciliation', datePostingInCell: '2024-03-05' },
 { id: 'u16', name: 'V. Singh', email: 'v2.utsprs@delhi.nr.in',
 role: 'user', cell: 'UTS PRS', designation: 'COS/UTS-PRS', division: 'Delhi',
 approved: true, createdAt: '2024-10-10',
 fatherHusbandName: 'J. Singh', workingAs: 'COS',
 listOfWorkAssigned: 'Booking clerk roster, counter audit support, MIS compilation', datePostingInCell: '2024-10-10' },
 { id: 'u17', name: 'L. Arora', email: 'l3.utsprs@delhi.nr.in',
 role: 'user', cell: 'UTS PRS', designation: 'OS/UTS-PRS', division: 'Delhi',
 approved: true, createdAt: '2025-03-01',
 fatherHusbandName: 'P. Arora', workingAs: 'OS',
 listOfWorkAssigned: 'PRS reservation records, refund processing oversight', datePostingInCell: '2025-03-01' },
 // 8. JTBS/YTSK/STBA
 { id: 'u18', name: 'Suresh Yadav', email: 'suresh.jtbs@delhi.nr.in',
 role: 'user', cell: 'JTBS/YTSK/STBA', designation: 'Dealer/JTBS', division: 'Delhi',
 approved: true, createdAt: '2024-03-10',
 fatherHusbandName: 'R.P. Yadav', workingAs: 'Dealer',
 listOfWorkAssigned: 'JTBS counter operations, ticket stock management, daily reconciliation', datePostingInCell: '2024-03-10' },
 { id: 'u19', name: 'K. Pandit', email: 'k2.jtbs@delhi.nr.in',
 role: 'user', cell: 'JTBS/YTSK/STBA', designation: 'OS/JTBS', division: 'Delhi',
 approved: true, createdAt: '2024-12-01',
 fatherHusbandName: 'B. Pandit', workingAs: 'OS',
 listOfWorkAssigned: 'Dealer agreement renewals, license compliance monitoring', datePostingInCell: '2024-12-01' },
 // 9. Store
 { id: 'u20', name: 'Kavita Bhatia', email: 'kavita.store@delhi.nr.in',
 role: 'user', cell: 'Store', designation: 'OS/Store', division: 'Delhi',
 approved: true, createdAt: '2024-03-15',
 fatherHusbandName: 'S.K. Bhatia', workingAs: 'OS',
 listOfWorkAssigned: 'Inventory management, stationery procurement, asset register maintenance', datePostingInCell: '2024-03-15',
 mustChangePassword: true, },
 { id: 'u21', name: 'H. Malhotra', email: 'h2.store@delhi.nr.in',
 role: 'user', cell: 'Store', designation: 'COS/Store', division: 'Delhi',
 approved: true, createdAt: '2025-01-15',
 fatherHusbandName: 'G. Malhotra', workingAs: 'COS',
 listOfWorkAssigned: 'Stock indent processing, store correspondence', datePostingInCell: '2025-01-15' },
 // 10. Sanitation
 { id: 'u22', name: 'Mohit Saxena', email: 'mohit.sanitation@delhi.nr.in',
 role: 'user', cell: 'Sanitation', designation: 'CMI/Sanitation', division: 'Delhi',
 approved: true, createdAt: '2024-03-20',
 fatherHusbandName: 'R.C. Saxena', workingAs: 'CMI',
 listOfWorkAssigned: 'Station cleanliness audits, sanitation contractor monitoring, Swachhata ranking', datePostingInCell: '2024-03-20' },
 { id: 'u23', name: 'A. Rathi', email: 'a2.sanitation@delhi.nr.in',
 role: 'user', cell: 'Sanitation', designation: 'Dealer/Sanitation', division: 'Delhi',
 approved: true, createdAt: '2024-09-30',
 fatherHusbandName: 'M. Rathi', workingAs: 'Dealer',
 listOfWorkAssigned: 'Contract execution oversight, sanitation staff deployment', datePostingInCell: '2024-09-30' },
 // 11. Catering
 { id: 'u24', name: 'Amit Singh', email: 'amit.catering@delhi.nr.in',
 role: 'user', cell: 'Catering', designation: 'Dealer/Catering', division: 'Delhi',
 approved: true, createdAt: '2024-03-25',
 fatherHusbandName: 'B.S. Singh', workingAs: 'Dealer',
 listOfWorkAssigned: 'Onboard catering quality checks, vendor licensing, complaint redressal', datePostingInCell: '2024-03-25' },
 { id: 'u25', name: 'N. Bhardwaj', email: 'n2.catering@delhi.nr.in',
 role: 'user', cell: 'Catering', designation: 'COS/Catering', division: 'Delhi',
 approved: true, createdAt: '2024-11-20',
 fatherHusbandName: 'R. Bhardwaj', workingAs: 'COS',
 listOfWorkAssigned: 'Catering contract administration, billing reconciliation', datePostingInCell: '2024-11-20' },
 // 12. Parking
 { id: 'u26', name: 'Priti Sharma', email: 'priti.parking@delhi.nr.in',
 role: 'user', cell: 'Parking', designation: 'Dealer/Parking', division: 'Delhi',
 approved: true, createdAt: '2024-04-01',
 fatherHusbandName: 'D.K. Sharma', workingAs: 'Dealer',
 listOfWorkAssigned: 'Parking contractor supervision, revenue collection audit', datePostingInCell: '2024-04-01' },
 { id: 'u27', name: 'Y. Kapoor', email: 'y2.parking@delhi.nr.in',
 role: 'user', cell: 'Parking', designation: 'OS/Parking', division: 'Delhi',
 approved: true, createdAt: '2025-02-05',
 fatherHusbandName: 'N. Kapoor', workingAs: 'OS',
 listOfWorkAssigned: 'Parking licence renewal, complaint tracking', datePostingInCell: '2025-02-05' },
 // 13. Publicity
 { id: 'u28', name: 'Dinesh Tripathi', email: 'dinesh.publicity@delhi.nr.in',
 role: 'user', cell: 'Publicity', designation: 'CMI/Publicity', division: 'Delhi',
 approved: true, createdAt: '2024-04-05',
 fatherHusbandName: 'M.P. Tripathi', workingAs: 'CMI',
 listOfWorkAssigned: 'Advertisement contract management, hoarding inventory, publicity events', datePostingInCell: '2024-04-05' },
 { id: 'u29', name: 'S. Dutta', email: 's2.publicity@delhi.nr.in',
 role: 'user', cell: 'Publicity', designation: 'Dealer/Publicity', division: 'Delhi',
 approved: true, createdAt: '2024-10-15',
 fatherHusbandName: 'K. Dutta', workingAs: 'Dealer',
 listOfWorkAssigned: 'Hoarding site execution, vendor coordination', datePostingInCell: '2024-10-15' },
 // 14. License Porter
 { id: 'u30', name: 'Sanjay Rawat', email: 'sanjay.porter@delhi.nr.in',
 role: 'user', cell: 'License Porter', designation: 'OS/Porter', division: 'Delhi',
 approved: true, createdAt: '2024-04-10',
 fatherHusbandName: 'G.S. Rawat', workingAs: 'OS',
 listOfWorkAssigned: 'Porter licence issuance, roster maintenance, rate chart display compliance', datePostingInCell: '2024-04-10' },
 { id: 'u31', name: 'P. Thapa', email: 'p2.porter@delhi.nr.in',
 role: 'user', cell: 'License Porter', designation: 'COS/Porter', division: 'Delhi',
 approved: true, createdAt: '2024-12-20',
 fatherHusbandName: 'R. Thapa', workingAs: 'COS',
 listOfWorkAssigned: 'Porter ID verification, complaint register', datePostingInCell: '2024-12-20' },
 // 15. Complaint/RailMadad
 { id: 'u32', name: 'Deepak Verma', email: 'deepak.complaint@delhi.nr.in',
 role: 'user', cell: 'Complaint/RailMadad', designation: 'CMI/Complaints', division: 'Delhi',
 approved: true, createdAt: '2024-04-15',
 fatherHusbandName: 'O.P. Verma', workingAs: 'CMI',
 listOfWorkAssigned: 'RailMadad escalation monitoring, TAT compliance, complaint analytics', datePostingInCell: '2024-04-15' },
 { id: 'u33', name: 'R. Saini', email: 'r2.complaint@delhi.nr.in',
 role: 'user', cell: 'Complaint/RailMadad', designation: 'OS/Complaints', division: 'Delhi',
 approved: true, createdAt: '2025-01-08',
 fatherHusbandName: 'K. Saini', workingAs: 'OS',
 listOfWorkAssigned: 'Complaint logging, follow-up correspondence', datePostingInCell: '2025-01-08' },
 // 16. Concession
 { id: 'u34', name: 'Neelam Singh', email: 'neelam.concession@delhi.nr.in',
 role: 'user', cell: 'Concession', designation: 'COS/Concession', division: 'Delhi',
 approved: true, createdAt: '2024-04-20',
 fatherHusbandName: 'A.S. Singh', workingAs: 'COS',
 listOfWorkAssigned: 'Concession pass verification, eligibility documentation, renewal processing', datePostingInCell: '2024-04-20' },
 { id: 'u35', name: 'V. Chawla', email: 'v2.concession@delhi.nr.in',
 role: 'user', cell: 'Concession', designation: 'OS/Concession', division: 'Delhi',
 approved: true, createdAt: '2024-11-10',
 fatherHusbandName: 'B. Chawla', workingAs: 'OS',
 listOfWorkAssigned: 'Pass issuance records, applicant database maintenance', datePostingInCell: '2024-11-10' },
 // 17. PA
 { id: 'u36', name: 'Rahul Tiwari', email: 'rahul.pa@delhi.nr.in',
 role: 'user', cell: 'PA', designation: 'PA to Sr.DCM', division: 'Delhi',
 approved: true, createdAt: '2024-04-25',
 fatherHusbandName: 'S.N. Tiwari', workingAs: 'OS',
 listOfWorkAssigned: 'Sr.DCM correspondence, appointment scheduling, file movement tracking', datePostingInCell: '2024-04-25' },
 // 18. Commercial Control
 { id: 'u37', name: 'Geeta Chauhan', email: 'geeta.control@delhi.nr.in',
 role: 'user', cell: 'Commercial Control', designation: 'CMI/Comml.Control', division: 'Delhi',
 approved: true, createdAt: '2024-05-01',
 fatherHusbandName: 'R.K. Chauhan', workingAs: 'CMI',
 listOfWorkAssigned: 'Real-time train monitoring, commercial control room operations, incident logging', datePostingInCell: '2024-05-01' },
 { id: 'u38', name: 'T. Negi', email: 't2.control@delhi.nr.in',
 role: 'user', cell: 'Commercial Control', designation: 'COS/Comml.Control', division: 'Delhi',
 approved: true, createdAt: '2024-08-22',
 fatherHusbandName: 'M. Negi', workingAs: 'COS',
 listOfWorkAssigned: 'Control room shift roster, daily situation reports', datePostingInCell: '2024-08-22' },
 // 19. Union/DRUCC
 { id: 'u39', name: 'P.S. Negi', email: 'ps.union@delhi.nr.in',
 role: 'user', cell: 'Union/DRUCC', designation: 'OS/DRUCC', division: 'Delhi',
 approved: true, createdAt: '2024-05-05',
 fatherHusbandName: 'D.S. Negi', workingAs: 'OS',
 listOfWorkAssigned: 'DRUCC meeting coordination, union correspondence, grievance compilation', datePostingInCell: '2024-05-05' },
 // 20. DAK
 { id: 'u40', name: 'Harish Pandey', email: 'harish.dak@delhi.nr.in',
 role: 'user', cell: 'DAK', designation: 'OS/DAK', division: 'Delhi',
 approved: true, createdAt: '2024-05-10',
 fatherHusbandName: 'G.N. Pandey', workingAs: 'OS',
 listOfWorkAssigned: 'Inward/outward dak register, file dispatch tracking, postal correspondence', datePostingInCell: '2024-05-10' },
 { id: 'u41', name: 'S. Mathur', email: 's2.dak@delhi.nr.in',
 role: 'user', cell: 'DAK', designation: 'COS/DAK', division: 'Delhi',
 approved: true, createdAt: '2025-01-30',
 fatherHusbandName: 'V. Mathur', workingAs: 'COS',
 listOfWorkAssigned: 'Dak receipt acknowledgement, courier coordination', datePostingInCell: '2025-01-30' },
];
