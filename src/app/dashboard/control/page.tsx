...
export default function Page() {
 ...
 <CellStaffRoster cell="Commercial Control"/>
 <CellDataManager cell="Commercial Control"/>
 <SharedTablesView cell="Commercial Control"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Commercial Control</h1>
