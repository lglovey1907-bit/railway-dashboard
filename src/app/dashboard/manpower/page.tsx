...
export default function Page() {
 ...
 <CellStaffRoster cell="Manpower Planning"/>
 <CellDataManager cell="Manpower Planning"/>
 <SharedTablesView cell="Manpower Planning"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Manpower Planning</h1>
