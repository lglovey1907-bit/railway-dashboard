...
export default function Page() {
 ...
 <CellStaffRoster cell="Concession"/>
 <CellDataManager cell="Concession"/>
 <SharedTablesView cell="Concession"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Concession</h1>
