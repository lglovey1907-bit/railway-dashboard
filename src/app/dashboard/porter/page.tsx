...
export default function Page() {
 ...
 <CellStaffRoster cell="License Porter"/>
 <CellDataManager cell="License Porter"/>
 <SharedTablesView cell="License Porter"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">License Porter</h1>
