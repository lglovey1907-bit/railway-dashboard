...
export default function Page() {
 ...
 <CellStaffRoster cell="Union/DRUCC"/>
 <CellDataManager cell="Union/DRUCC"/>
 <SharedTablesView cell="Union/DRUCC"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Union / DRUCC</h1>
