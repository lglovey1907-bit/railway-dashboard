...
export default function Page() {
 ...
 <CellStaffRoster cell="Security D&AR"/>
 <CellDataManager cell="Security D&AR"/>
 <SharedTablesView cell="Security D&AR"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Security / D&AR</h1>
