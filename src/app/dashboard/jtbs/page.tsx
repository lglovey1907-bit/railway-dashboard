...
export default function Page() {
 ...
 <CellStaffRoster cell="JTBS/YTSK/STBA"/>
 <CellDataManager cell="JTBS/YTSK/STBA"/>
 <SharedTablesView cell="JTBS/YTSK/STBA"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">JTBS / YTSK / STBA</h1>
