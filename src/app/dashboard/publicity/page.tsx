...
export default function Page() {
 ...
 <CellStaffRoster cell="Publicity"/>
 <CellDataManager cell="Publicity"/>
 <SharedTablesView cell="Publicity"/>
 ...
 <h1 className="text-slate-800/60 text-lg font-bold">Publicity</h1>
